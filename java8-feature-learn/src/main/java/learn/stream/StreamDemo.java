...
public class StreamDemo {
     ...
     * unordered：
     */
    public void streamIntermediate() throws IOException {
        //清单 7. 转换大写
        ...
        output = reader.lines().flatMap(line -> Stream.of(line.split("\n"))).
        ...
        List<Person> personList3 = persons.stream().sorted((p1, p2) ->
        ...
        List<Person> personList4 = persons.stream().limit(2)
     ...
     * iterator
     */
    public void streamTerminal() throws IOException {

        //清单 12. 打印姓名（forEach 和 pre-java8 的对比）
        List<Person> roster = Arrays.asList(new Person(1, "tom", 10),
                new Person(2, "jerry", 5));
        roster.stream()
