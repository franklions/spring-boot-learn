...
//    public static final String SIGNATURE_ALGORITHM = "MD5withRSA";
    public static final Map<String,String> SIGNATURE_ALGORITHM = new HashMap<String,String>(){
        {put("MD5","MD5withRSA");
            put("SHA1","SHA1withRSA");
            put("SHA256","SHA256withRSA");}
    };
     ...
     * @throws Exception
     */
    public static String sign(byte[] data, String privateKey,String signatureKey) throws Exception {
